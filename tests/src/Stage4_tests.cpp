...
TEST(Stage4_Context, EmptyContext)
{
	/*Init*/
...
TEST(Stage4_Context, ThrowsIfUnknownOption)
{
	/*Init*/
...
TEST(Stage4_Context, ThrowsIfMissmatchArity)
{
	/*Init*/
	Subcommand subcommand = Subcommand("subcommand", nullptr);
	ContextBuilder builder = ContextBuilder();
...
TEST(Stage4_Context, ConcatToken)
{
	/*Init*/
...
TEST(Stage4_Context, ConcatTokenWithLastOptionArgument)
{
	/*Init*/
...
TEST(Stage4_Context, ThrowsIfConcatTokenHasMiddleOptionArgument)
{
	/*Init*/
	const std::string arg = "foo";
	const std::string concatFlag = "-abc";
...
TEST(Stage4_Context, ThrowsIfGetEmptyArg)
{
	/*Init*/
	std::string flag = "-a";
...
TEST(Stage4_Context, ThrowsIfGetAllEmptyArg)
{
	/*Init*/
	std::string flag = "-a";
	Token token = Token(flag, {});
...
TEST(Stage4_Context, GetTypedArg)
{
	/*Init*/
...
TEST(Stage4_Context, GetAllTypedArg)
{
	/*Init*/
