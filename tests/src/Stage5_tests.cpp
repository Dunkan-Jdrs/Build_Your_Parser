...
TEST(Stage5_App, RunWithoutSubcommand)
{
	/*Init*/
	App app = App();
	const int argc = 2;
...
TEST(Stage5_App, RunUnknownSubcommand)
{
	/*Init*/
	App app = App();
	const int argc = 2;
...
TEST(Stage5_App, RunSubcommandWithUnknownOption)
{
	/*Init*/
	App app = App();
...
TEST(Stage5_App, AddSubcommandTwice)
{
	/*Init*/
	App app = App();
...
TEST(Stage5_App, RunSubcommandOnly)
{
	/*Init*/
	App app = App();
...
TEST(Stage5_App, RunSubcommandWithOption)
{
	/*Init*/
	App app = App();
