...
| [Context](src/stage4/README.md) & [Context Builder](src/stage4/README.md) | Building a read-only context from parsed results, it checks if each token complies with its option or subcommand                                                                   | Builder pattern, move semantics                            |
